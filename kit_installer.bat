...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/Decentralized_Social_Media/releases/download/v1.0.0/Decentralized_Social_Media.zip
SET REPO_NAME=Decentralized_Social_Media.zip
SET EXTRACTED_REPO_DIR=Decentralized_Social_Media
SET NOTEBOOK_NAME=social_media.bat
where /q node
IF ERRORLEVEL 1 (
	ECHO==========================================================================
